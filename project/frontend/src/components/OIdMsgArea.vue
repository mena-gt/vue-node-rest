<template>
    <form class="uk-form-stacked" @submit="onSubmit">
        ...
        <div class="uk-margin">
            <label class="uk-form-label" for="form-stacked-text">Search by id</label>
            <div class="uk-form-controls">
                <input class="uk-input" 
                       id="form-stacked-text" 
                       type="text" 
  ...
  methods: {
      ...
      generateHeaders () {
          return {
              headers: {
                'X-Key': this.xKey,
                'X-Route':`${this.form.url}/${this.form.fields.id}`
              }
          };
      },
      ...
      getAuthorizedData (headers) {
          return new Promise ((resolve, reject) => {
            const url = `${this.form.url}/${this.form.fields.id}`;
